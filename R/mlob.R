...
#'beta_b -3.34878   127.8704      -253.9702       247.2726 -0.02618886 0.9791067             
#'
#
#'For comparison, summary of coefficients from unoptimized analysis (ML):
#'  Estimate Std. Error Lower CI (95%) Upper CI (95%)     Z value  Pr(>|z|) Significance
#'beta_b -2.890074    227.665      -449.1053       443.3251 -0.01269442 0.9898716             

#'Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
#' }
#' Warning message:
#'In mlob(weight ~ Time, data = ChickWeight, group = "Diet", punish.coeff = 1.5,  :
#'          Your data is unbalanced. Balancing procedure was used and 18.3% of data was deleted.
#'        Deleted entries: 106
#'        Deleted groups: 0
#'        
...
#'  Summary of Coefficients:
#'Estimate   Std. Error Lower CI (95%) Upper CI (95%)       Z value  Pr(>|z|) Significance
#'beta_b      -0.11797219 2.003669e+14  -3.927118e+14   3.927118e+14 -5.887809e-16 1.0000000             
#'gamma_wt    -5.04069754 1.373862e+01  -3.196790e+01   2.188651e+01 -3.668998e-01 0.7136938             
#'gamma_am     3.58187392 1.096970e+01  -1.791834e+01   2.508209e+01  3.265244e-01 0.7440276             
#'gamma_hp:wt  0.01500433 3.030951e-02  -4.440121e-02   7.440988e-02  4.950372e-01 0.6205739             
#'gamma_hp:am -0.02741907 7.281763e-02  -1.701390e-01   1.153009e-01 -3.765443e-01 0.7065123             
#'
#'
#'For comparison, summary of coefficients from unoptimized analysis (ML):
#'  Estimate   Std. Error Lower CI (95%) Upper CI (95%)       Z value  Pr(>|z|) Significance
...
#'Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
#' Warning messages:
#'1: In mlob(mpg ~ hp + wt + am + hp:wt + hp:am, data = mtcars, group = "cyl",  :
#'     Your data is unbalanced. Balancing procedure was used and 34.4% of data was deleted.
#'     Deleted entries: 11
#'     Deleted groups: 0
#'2: In mlob(mpg ~ hp + wt + am + hp:wt + hp:am, data = mtcars, group = "cyl",  :
#'      You changed the balancing limit to fine-tune the balancing.
